...
public:
	...
	static void devicesChangedCallback(std::vector<MV3D_RGBD_DEVICE_INFO>* removed, std::vector<MV3D_RGBD_DEVICE_INFO>* added, void* param);
	//virtual void devicesChanged(rs2_device_list* removed, rs2_device_list* added);
	virtual void devicesChanged(std::vector<MV3D_RGBD_DEVICE_INFO>* removed, std::vector<MV3D_RGBD_DEVICE_INFO>* added);
